...
class Client
{
    ...
    */
    ...
    public function isTelephoneValid(ExecutionContextInterface $context)
    {
        ...
        if(!preg_match("#^0[1-9]([-. ]?[0-9]{2}){4}$#", $tel) && !preg_match("#^\+[0-9]{1,2}[0-9]{1,2}([-. ]?[0-9]{2}){4}$#", $tel)){
            $context
     ...
     * Add deviss
     *
     * @param \LG\MyAEBundle\Entity\Devis $deviss
     *
     * @return Client
     */
    public function addDeviss(\LG\MyAEBundle\Entity\Devis $deviss)
    {
        $this->deviss[] = $deviss;
     ...
     * @param \LG\MyAEBundle\Entity\Devis $deviss
     */
    public function removeDeviss(\LG\MyAEBundle\Entity\Devis $deviss)
    {
